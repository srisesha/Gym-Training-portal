...
{
	$id=$_REQUEST['couid'];
	$q="select *from courses where cid=$id";
...
echo "<table align='center' cellpadding='10' cellspacing='10' >";
	...
	{
		$id=$r['cid'];
		echo "<tr><td><b>Course No:</b></td><td>".$r['cid']."</td></tr>";
		echo "<tr><td><b>Course Name:</b></td><td>".$r['cname']."</td></tr>";
		echo "<tr><td><b>Batch:</b></td><td>".$r['batch']."</td></tr>";
		echo "<tr><td><b>Timings:</b></td><td>".$r['timings']."</td></tr>";
		echo "<tr><td><b>Trainer:</b></td><td>".$r['trainer']."</td></tr>";
		echo "<tr><td><b>Trainer Detail:</b></td><td>".$r['trainerinfo']."</td></tr>";
		echo "<tr><td><b>Duration:</b></td><td>".$r['duration']."</td></tr>";
		echo "<tr><td><b>Fees:</b></td><td>".$r['fees']."</td></tr>";
