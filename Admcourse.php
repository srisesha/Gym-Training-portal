...
if(isset($_REQUEST['insert']))
{
	...
	{
		$q="insert into courses(cname,batch,timings,trainer,trainerinfo,duration,fees) values('$course','$batch','$timing','$trainer','$trinfo','$duration',$fees)";
		
		$result=mysqli_query($con,$q);
		echo mysqli_error($con);
		echo "<script>alert('Training Details updated successfully..')</script>";
	}
...
<tr><td colspan="2" align="center"><h2>Training Details</h2></td></tr>
<tr><td>Course Name:</td><td><input type="text" name="course" id="course" required></td></tr>
<tr><td>Batch:</td><td><input type="text" name="batch" id="batch" required></td></tr>
<tr><td>Timings:</td><td><input type="text" name="timing" id="timing" required></td></tr>
<tr><td>Trainer:</td><td><input type="text" name="trainer" id="trainer" required></td></tr>
<tr><td>Trainer Details:</td><td><textarea name="trinfo" id="trinfo" required></textarea></td></tr>

<tr><td>Duration:</td><td><input type="text" name="duration" id="duration" required></td></tr>
<tr><td>Fees:</td><td><input type="text" name="fees" id="fees" required></td></tr>
